...
- Step 지시 파일: `.Codex/skills/harness/templates/step.md`
- Phase index: `.Codex/skills/harness/templates/phase-index.json`
- Top index: `.Codex/skills/harness/templates/top-index.json`
- Progress: `.Codex/skills/harness/templates/progress.md`
- Feature list: `.Codex/skills/harness/templates/feature_list.json`
