...
## 마지막 업데이트
2026-06-10T00:00:47+0900 — Step 3/3 완료
...
- Step 3: uninstall-status-codex — uninstall.ts에 removeCodexHooks 호출 추가(.codex/hooks.json 존재 시), status.ts에 hasCodexHooks 호출 + 'Codex hooks: registered/not registered' 출력 추가
